...
class CheckCompanyRegisteredOfficeAddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  "CheckCompanyRegisteredOfficeAddress Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, checkCompanyRegisteredOfficeAddressRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, checkCompanyRegisteredOfficeAddressRoute)
