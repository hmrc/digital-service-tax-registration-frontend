...
import views.html.CheckCompanyRegisteredOfficePostcodeView

import scala.concurrent.Future

class CheckCompanyRegisteredOfficePostcodeControllerSpec extends SpecBase with MockitoSugar {
  ...
  "CheckCompanyOfficeRegisteredPostcode Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, checkCompanyRegisteredOfficePostcodeRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, checkCompanyRegisteredOfficePostcodeRoute)
            .withFormUrlEncodedBody(("company-registered-office-postcode", "SW3 5DA"))
    ...
    "must return a Bad Request and errors when no data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, checkCompanyRegisteredOfficePostcodeRoute)
            .withFormUrlEncodedBody(("company-registered-office-postcode", ""))

        val boundForm = form.bind(Map("company-registered-office-postcode" -> ""))
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, checkCompanyRegisteredOfficePostcodeRoute)
            .withFormUrlEncodedBody(("company-registered-office-postcode", "isdfgslajfda"))

        val boundForm = form.bind(Map("company-registered-office-postcode" -> "isdfgslajfda"))
