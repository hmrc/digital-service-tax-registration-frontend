...
class UltimateParentCompanyNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  "UltimateParentCompanyName Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, ultimateParentCompanyNameRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(UltimateParentCompanyNamePage, "answer").success.value
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, ultimateParentCompanyNameRoute)
